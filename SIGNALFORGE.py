...
def main(stocks):
    ...
    buys.to_excel("advanced_buy_signals.xlsx", index=False)

    print("\nSaved:")
    print("advanced_swing_trades.xlsx")
    print("advanced_buy_signals.xlsx")
    ...
    try:
        ...
        plt.xlabel("Relative Strength vs SPY")

        plt.ylabel("Backtest Win Rate")

        plt.title("Best Swing Trading Candidates")
